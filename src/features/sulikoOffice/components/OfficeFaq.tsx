...
export default function OfficeFaq() {
  ...
  return (
    <section id="faq" className={`${CONTAINER} ${SECTION_ANCHOR} grid items-start gap-10 py-20 lg:grid-cols-[400px_minmax(0,1fr)] lg:gap-20 lg:py-24`}>
      ...
      <div className="flex flex-col border-t border-border">
        {FAQ_KEYS.map((n) => (
          <details key={n} open={n === 1} data-reveal style={revealDelay(n * 70)} className="group border-b border-border">
