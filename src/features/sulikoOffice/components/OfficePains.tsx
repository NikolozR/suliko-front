  ...
  return (
    <section className={ALT_SECTION}>
      <div className={`${CONTAINER} flex flex-col gap-6 py-14`}>
        <p className="text-[15px] tracking-[0.3px] text-muted-foreground">{t("kicker")}</p>
        <div className="grid gap-6 md:grid-cols-3">
          {pains.map(({ q, a }) => (
            <div key={q} className="flex flex-col gap-4 rounded-2xl border border-border bg-background p-7">
