...
export default function Home() {
  return (
    <div className="flex flex-col-reverse sm:flex-row justify-center items-center sm:h-screen">
      <div className="flex relative items-center w-full sm:w-[50%] justify-center sm:h-screen">
        <div>
